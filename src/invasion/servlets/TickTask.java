...
public class TickTask extends TimerTask
{
    ...
    public static final String KEY = TickTask.class.getName();
    public static final Logger log = Logger.getLogger( KEY );

    private InvasionConnection conn = null;
     ...
     * @throws SQLException for ease - don't want to deal with this here.
     */
    private void adjustStats() throws SQLException
    {
    ...
    private void checkLevels() throws SQLException
    {
