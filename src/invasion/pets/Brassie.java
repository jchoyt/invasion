...
public class Brassie extends Critter
{
  public static final String KEY = Brassie.class.getName();
  public static final Logger log = Logger.getLogger(KEY);
  static { log.setLevel(Level.FINER); }

  protected double defenderChance = 0D;

  public Brassie(Brood brood)
  {
    setBrood(brood);
    init();
  }
  ...
  public void init()
  {
    if (this.brood == null)
    {
      throw new RuntimeException("Can't initialize a " + KEY + " without having assigning a Brood first.");
    }
    int skillLevel = 1;
    ...
    this.name = ("Brassie " + (int)(Math.random() * 2500.0D));
    this.typeid = 5;
    this.damageType = 'e';
    this.defenderChance = (0.05D * skillLevel);
    this.deathKnells = new String[] { "You have landed the killing blow.", "The Brassie releases a horrendous howl of pain and collapses, dead." };

    this.summonMessages = new String[] { "The familiar swirl of light appears to your left.  It grows slowly.  As soon as it is big enough, a Brassie steps through and immediatly binds itself to your soul.", "With a faint *pop* and a flash of dull green light, a Brassie appears behind you, ready to do your bidding." };
  }
