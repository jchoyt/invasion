  ...
  implements PropertyChangeListener
{
  ...
  public boolean update(InvasionConnection conn)
  {
    ...
    int count = conn.psExecuteUpdate(query, "Error updating brood in the database", new Object[] { Integer.valueOf(this.location), Integer.valueOf(this.type), Integer.valueOf(this.goals[0]), Integer.valueOf(this.goals[1]), Integer.valueOf(this.goals[2]), Integer.valueOf(this.goals[3]), Integer.valueOf(this.goals[4]), Integer.valueOf(this.id) });
    if (count != 1)
    {
  ...
  public void act(InvasionConnection conn, InvasionConnection pConn)
  {
    ...
    if ((this.ownerId < 1) && (this.targetList.size() == 0))
    {
      ...
      try
      {
        rs = pConn.psExecuteQuery(query, "Brood movmement not updated", new Object[] { Integer.valueOf(this.location) });
        while (rs.next())
        {
  ...
  public void buildTargetList(InvasionConnection conn)
  {
    ...
    try
    {
      if ((LocationCache.getCharactersAtLoc(this.location) > 1) || ((LocationCache.getCharactersAtLoc(this.location) > 0) && (this.ownerId < 1)))
      {
        ...
        rs = conn.psExecuteQuery(query, "Error", new Object[] { Integer.valueOf(this.location) });
        while (rs.next())
        {
  ...
  protected boolean delete(InvasionConnection conn)
  {
    ...
    return 1 == conn.psExecuteUpdate(query, "Deleting merged brood", new Object[] { Integer.valueOf(this.id) });
  }
